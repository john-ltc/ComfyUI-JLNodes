...
# print("[JLNodes] JLLoadLatent module loaded")
class LoadLatent:
    """
    ...
    def load_latent(self, latent_file: str):
        ...
        try:
            ...
            print(f"[JLLoadLatent] Failed to load '{latent_file}': {e}")
...
# -------------------------
# Node registration (UNIQUE KEY)
# -------------------------
NODE_CLASS_MAPPINGS = {
    "JLLoadLatent": LoadLatent
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "JLLoadLatent": "Load Latent"
}
